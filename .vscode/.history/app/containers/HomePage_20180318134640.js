...
const selectEquipment = type => (exp, id) => exp.entities[type][id];
const selectBuret = selectEquipment('buret');

const mapStateToProps: MapStateToProps<State, OwnProps, StateProps> = (
  { acidBaseExperimentNew },
  ownprops
) => {
  const buret = selectBuret(acidBaseExperimentNew, ownprops.id);
  return {
    buret: {
      ...buret,
      isRight: ownprops.isRight,
    },
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(BuretDragSource);